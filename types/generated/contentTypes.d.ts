...
export interface ApiHabitHabit extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['zywienie', 'suplementacja', 'ruch', 'pielegnacja', 'mindfulness']
    > &
      Schema.Attribute.Required;
    content: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dailyGoal: Schema.Attribute.Integer;
    ...
    type: Schema.Attribute.Enumeration<
      ['foundation', 'program', 'phase', 'additional']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'program'>;
    unit: Schema.Attribute.Enumeration<['tak-nie', 'licznik', 'minuty']> &
      Schema.Attribute.DefaultTo<'tak-nie'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiInstructionInstruction extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Dok\u0142adna instrukcja obs\u0142ugi systemu dla tw\u00F3rc\u00F3w tre\u015Bci';
    displayName: 'Instrukcja dla Eksperta';
...
export interface ApiMotivationQuoteMotivationQuote
  extends Struct.CollectionTypeSchema {
  collectionName: 'motivation_quotes';
  info: {
    description: 'Kr\u00F3tkie teksty motywacyjne wy\u015Bwietlane wszystkim u\u017Cytkownikom';
    displayName: 'Cytat motywacyjny';
    pluralName: 'motivation-quotes';
    singularName: 'motivation-quote';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::motivation-quote.motivation-quote'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProfileProfile extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Profile zdrowotne u\u017Cytkowniczek';
    displayName: 'Profil';
    pluralName: 'profiles';
...
export interface ApiSkinCareSkinCare extends Struct.CollectionTypeSchema {
  collectionName: 'skin_cares';
  info: {
    description: 'Porady piel\u0119gnacyjne dopasowane do fazy cyklu';
    displayName: 'Rytua\u0142 piel\u0119gnacyjny';
    pluralName: 'skin-cares';
    singularName: 'skin-care';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSymptomSymptom extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Objawy, kt\u00F3re u\u017Cytkowniczka mo\u017Ce zapisywa\u0107 codziennie';
    displayName: 'Objaw';
    pluralName: 'symptoms';
...
export interface ApiTrainingTraining extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Plany treningowe na ka\u017Cdy dzie\u0144 cyklu';
    displayName: 'Trening';
